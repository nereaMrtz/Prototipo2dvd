...
namespace ProjectDawn.SplitScreen
{
    ...
    public struct SplitScreen4 : ISplitScreen, IDisposable
    {
        ...
        public SplitScreen4(Allocator allocator = Allocator.Temp)
        {
            ...
            Sites = new NativeArray<float2>(4, allocator);
        }
        ...
        public void Reset(float3 w0, float3 w1, float3 w2, float3 w3, float scale = 2, float aspectRatio = 1, float BoundsRadius = 0.3f)
        {
            ...
            VoronoiBuilder.SetSites(w0.xy, w1.xy, w2.xy, w3.xy);
            ...
            var normalization = new VoronoiNormalizationScope(ref VoronoiBuilder, ref VoronoiDiagram, ref Sites);
            {
                ...
                if (balanceSettings.Enabled)
                {
                    if (balanceSettings.RelaxationIterations != 0)
                        FloydRelaxation.Execute(ref VoronoiBuilder, ref VoronoiDiagram, ref Sites, balanceSettings.RelaxationIterations);
        ...
        public void CreateScreens(in Translating translating, ref ScreenRegions screenRegions)
        {
            ...
            VoronoiRegion S3 = VoronoiDiagram.Regions[3];
            ...
            float2 center3 = VoronoiDiagram.GetCentroid(S3);
            ...
            if (translating.BlendShape == BlendShape.Region)
            {
                ...
                distance03 = VoronoiDiagram.GetDistanceBetweenRegions(S0, m_Scale, -center0 * m_Scale + player0, S3, m_Scale, -center3 * m_Scale + player3);
                distance32 = VoronoiDiagram.GetDistanceBetweenRegions(S3, m_Scale, -center3 * m_Scale + player3, S2, m_Scale, -center2 * m_Scale + player2);
                distance31 = VoronoiDiagram.GetDistanceBetweenRegions(S3, m_Scale, -center3 * m_Scale + player3, S1, m_Scale, -center1 * m_Scale + player1);
            }
            else
            {
                ...
                var circle3 = new Circle(player3, m_Scale * VoronoiDiagram.GetRegionInscribedCircleRadius(S3));
            ...
            screenRegions.AddRegion(VoronoiDiagram, S3, p3, u3);
            ...
            screenRegions.AddSplit(VoronoiDiagram, S0, S3, blend03);
            screenRegions.AddSplit(VoronoiDiagram, S3, S1, blend31);
            screenRegions.AddSplit(VoronoiDiagram, S3, S2, blend32);
        }
        ...
        public void DrawDelaunayDual()
        {
            ...
            DelaunayDual.GetTriangles(Sites[0], Sites[1], Sites[2], Sites[3], ref triangles);
